...
class RationaleDialogConfig {
    ...
    Dialog createSupportDialog(Context context, Dialog.OnClickListener listener) {
...
//                .create();
        return new PermissionDialog(context, positiveButton, negativeButton, rationaleMsg, listener);
    }

    Dialog createFrameworkDialog(Context context, Dialog.OnClickListener listener) {
